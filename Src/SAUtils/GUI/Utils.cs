...
public static class Utils {
    ...
    /// </summary>
    /// ------------------------------------------------------------------------------------
    public static bool SuppressMsgBoxInteractions {
        get;
        set;
    }
    ...
    public static bool MessageBoxJustShown {
        get {
            return s_msgBoxJustShown;
        } set {
            s_msgBoxJustShown = value;
        }
    }
    ...
    /// </summary>
    /// ------------------------------------------------------------------------------------
    public static void SetWindowRedraw(Control ctrl, bool turnOn, bool invalidateAfterTurningOn) {
