...
public class SplashScreenForm : Form {
    ...
    private void InitializeComponent() {
            ...
            this.picLoadingWheel.Image = global::SIL.SpeechAnalyzer.Properties.Resources.LoadingWheel;
            ...
            this.pictureBox1.Image = global::SIL.SpeechAnalyzer.Properties.Resources.kimidSilLogo;
    ...
    public bool ShowStandardSILContent {
        ...
        get {
            return m_showStandardSILContent;
        } set {
    ...
    /// ------------------------------------------------------------------------------------
    /// <summary>
    /// The product name which appears in the App product name on the splash screen
    /// </summary>
    /// <remarks>
    /// .Net clients should not set this. It will be ignored. They should set the
    /// AssemblyFileVersion attribute in AssemblyInfo.cs of the executable.
    ...
    protected override void OnShown(EventArgs e) {
        ...
        base.OnShown(e);
        GUI.Utils.CenterFormInScreen(this);
    }
