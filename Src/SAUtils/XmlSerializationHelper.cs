...
public static T DeserializeFromString<T>(string input, out Exception e) where T :
    ...
    /// ------------------------------------------------------------------------------------
public static T DeserializeFromFile<T>(string filename) where T :
    class {
        Exception e;
    ...
    /// </summary>
    /// ------------------------------------------------------------------------------------
public static T DeserializeFromFile<T>(string filename, string rootElementName) where T :
    class {
        Exception e;
...
where T :
    ...
    public static T DeserializeFromFile<T>(string filename, string rootElementName,
                                       bool fKeepWhitespaceInElements) where T :
    class {
        Exception e;
    ...
    /// ------------------------------------------------------------------------------------
public static T DeserializeFromFile<T>(string filename, out Exception e) where T :
    class {
        return DeserializeFromFile<T>(filename, false, out e);
    }
    ...
    /// --------------------------------------------------------------------------------
    public static T DeserializeFromFile<T>(string filename, string rootElementName,
                                       bool fKeepWhitespaceInElements, out Exception e) where T :
    class {
        T data = null;
        e = null;
