...
/// </summary>
/// ----------------------------------------------------------------------------------------
[ProgId("SpeechAnalyzer.SaAudioDocumentWriter")]
[ClassInterface(ClassInterfaceType.None)]
[GuidAttribute("5563C034-028D-4E25-BF51-AC41A8B7E489")]
[ComVisible(true)]
public class SaAudioDocumentWriter : ISaAudioDocumentWriter {
    ...
    /// </summary>
    /// ------------------------------------------------------------------------------------
    public bool Initialize( string audioFilePath, string origMD5HashCode, bool isForTempOperation) {

        bool result = Initialize( audioFilePath, isForTempOperation);
