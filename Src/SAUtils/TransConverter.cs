...
public class TransConverterInfo : List<TransConverter> {
    ...
    private bool EnsureConverterExists(TransConverter transConverter) {
        ...
        EncConverter converter = TransConverter.GetConverter(transConverter.Converter);

        if (converter == null) {
            // If the converter doesn't exist in the repository try the filename.
            converter = TransConverter.GetConverter(transConverter.Filename);
            ...
            if (converter != null) {
                ...
                TransConverter.EncodingConverters.Add(transConverter.Converter, converterFilename,
