...
#define  E_badin    2  /* grapplSetInbuff called with previous
input data still pending */
#define  E_badfrange  3  /* 'minpitch' or 'maxpitch' outside
permitted range of 20-1000Hz */
#define  E_badfgap  4  /* 'maxpitch' less than 25% greater than
'minpitch' */
#define  E_badmode  5  /* 'mode' parameter setting invalid */
#define  E_badsmooth  6  /* 'smoothfreq' outside permitted range
(500-2500Hz, or 0=no smoothing) */
#define  E_badsfreq  7  /* 'sampfreq' outside permitted range
(5000-50000Hz) */
#define  E_badreslag  8  /* 'reslag' value invalid (must be at least
10, or 0=use max possible) */
...
Boolean  grapplGetResults(pGrappl,pGrappl_res *,int16 *,int16 *);
Boolean grapplInit(pGrappl,pGrappl_parms);
Boolean grapplSetInbuff(pGrappl,pGrappl,uint16,int16);
