...
#define COMPLEX_H
 ...
 typedef struct {float real; float imag;} COMPLEX_RECT_FLOAT;                 
 typedef struct {float mag; float phase;} COMPLEX_POLAR_FLOAT;
 typedef union{COMPLEX_RECT_FLOAT rect; COMPLEX_POLAR_FLOAT polar;} COMPLEX_FLOAT;
