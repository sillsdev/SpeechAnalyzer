...
public:
  ...
  CString* GetChar() {return &m_szChar;} // return pointer to character string
  UINT GetID()   {return m_nID;}   // return character ID
  int  GetType() {return m_nType;} // return character type
  int  GetMode() {return m_nMode;} // return character mode
