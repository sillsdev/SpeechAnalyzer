...
/////////////////////////////////////////////////////////////////////////////
// CPlotWavelet message map

BEGIN_MESSAGE_MAP(CPlotWavelet, CPlotWnd)
	//{{AFX_MSG_MAP(CPlotWavelet)
	ON_WM_CREATE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
static struct RGB sparsePalette[sparsePaletteSize+1] =		// SDM 1.5Test10.3
{
	...
	// Constructor
	//*  Description   : Creates a new graph for the wavelet scalogram
	//*  Parameters    : None
	//*  Preconditions : None
	//*  Postcondtions : None
	//*  Returns       : A new CPlotWavelet instance
	//************************************************************************** 
	...
	// Deconstructor
	//*  Description   : Deletes the graph from memory
	//*  Parameters    : None
	//*  Preconditions : None
	//*  Postcondtions : None
	//*  Returns       : None
		...
		void CPlotWavelet::OnDraw(CDC *pDC, CRect rWnd, CRect rClip, CSaView * pView)
	{
		...
		//swprintf_s(str, "%g to %g", tempNode->GetLowerFrequencyBound(), tempNode->GetUpperFrequencyBound());
		//swprintf_s(str, "%d to %d", x, x + y);
		//m_HelperWnd.SetMode(MODE_TEXT | FRAME_POPIN | POS_HLEFT | POS_VTOP, CSaString(str), &rWnd);	
