...
public:
  ...
  CFont* GetFont() {return &m_font;} // return selected font
  int GetScaleMode() {return m_nScaleMode;} // return scale mode
  double GetFirstGridPosition() {return m_dFirstGridPos;} // return position of first gridline
  double GetGridDistance() {return m_fGridDistance;} // return distance between gridlines
  CString* GetDimensionText() {return &m_szScaleDimension;} // return pointer to dimension text
  double GetScaleBase() {return m_fBase;} // return base of scale
  double GetScaleMaxValue() {return m_dScaleMaxValue;} // return max scale value
  double GetScaleMinValue() {return m_dScaleMinValue;} // return min scale value
  void OnDraw(CDC * pDC,
...
public:
  ...
  CFont* GetFont() {return &m_font;} // return selected font
  int GetScaleMode() {return m_nScaleMode;} // return scale mode
  double GetFirstGridPosition() {return m_fFirstGridPos;} // return position of first gridline
  double GetGridDistance() {return m_fGridDistance;} // return distance between gridlines
  CString* GetDimensionText() {return &m_szScaleDimension;} // return pointer to dimension text
...
public:
  ...
  void SetHintUpdateBoundaries(BOOL bHint, BOOL bOverlap) {SetHintUpdateBoundaries(bHint,m_dwHintStart,m_dwHintStop, bOverlap);};
