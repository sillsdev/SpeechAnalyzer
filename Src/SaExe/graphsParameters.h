...
private:
	...
	//{{AFX_DATA(CDlgParametersPitchPage)
...
public:
	...
	CDlgParametersSpectroPage(UINT dialogID, UINT graphId, const SpectroParm * defaults);
...
protected:
	...
	BOOL m_bModified; // TRUE if page member data modified
	// Dialog Data
	//{{AFX_DATA(CDlgParametersSpectroPage)
...
protected:
	...
	//{{AFX_MSG(CDlgParametersSpectroPage)
