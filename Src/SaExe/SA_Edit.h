...
public:
  ...
  // Operations
public:
  CMainFrame* MainFrame() const {return (CMainFrame*)AfxGetMainWnd();};
...
public:
  ...
  BOOL Create( UINT nIDTemplate, CWnd* pParentWnd=NULL ) {return CDialog::Create(nIDTemplate, pParentWnd);};
  // Dialog Data
