...
public:
	CUtf32String() {;}
	explicit CUtf32String(unsigned long lChar) {*this += lChar;}
	virtual ~CUtf32String() {;}

	virtual operator CUtf8String() const;
	virtual operator CUtf16String() const;
	virtual operator CUtf32String() const {return *this;}
	...
	CUtf32String& operator+=(const CUnicodeString &szString) {m_szContents += CUtf32String(szString).m_szContents; return *this;}

	virtual BOOL IsEmpty() const {return size() == 0;}
	int size() const {return m_szContents.size();}
...
public:
	...
	virtual operator CUtf8String() const;
	virtual operator CUtf16String() const {return *this;}
	virtual operator CUtf32String() const;

	std::wstring getUtf16() const { return m_szContents;}
	virtual std::string Encode(CFont *pFont) const;

	virtual CUnicodeString& operator=(const CUtf16String &szNew) {m_szContents = szNew.m_szContents;return *this;}
	virtual CUnicodeString& operator=(const CUnicodeString &szNew) {m_szContents = CUtf16String(szNew).m_szContents;return *this;}
	CUtf16String& operator+=(const CUnicodeString &szString) {m_szContents += CUtf16String(szString).m_szContents; return *this;}
...
public:
	...
	virtual operator CUtf8String() const {return *this;}
	virtual operator CUtf16String() const;
	virtual operator CUtf32String() const;

	std::string getUtf8() const { return m_szContents;}

	virtual CUnicodeString& operator=(const CUtf8String &szNew) {m_szContents = szNew.m_szContents;return *this;}
	virtual CUnicodeString& operator=(const CUnicodeString &szNew) {m_szContents = CUtf8String(szNew).m_szContents; return *this;}
	CUtf8String& operator+=(const CUnicodeString &szString) {m_szContents += CUtf8String(szString).m_szContents; return *this;}
