...
void CDlgAlignTranscriptionDataSegmentByPage::OnClicked() 
{
	...
	switch (m_nSegmentBy) 
	{
	case IDC_KEEP: SetText(IDC_DETAILS, IDS_AWIZ_DTL_KEEP); break;
	case IDC_MANUAL: SetText(IDC_DETAILS, IDS_AWIZ_DTL_MANUAL); break;
	case IDC_AUTOMATIC: SetText(IDC_DETAILS, IDS_AWIZ_DTL_AUTOMATIC); break;
	}
}
