...
{
	//{{AFX_DATA_INIT(CDlgOptionsViewPage)
	m_bStatusbar = FALSE;
	m_bToolbar = FALSE;
	m_bScrollZoom = FALSE;
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsViewPage helper functions
...
void CDlgOptionsViewPage::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CDlgOptionsViewPage)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsViewPage message handlers

/***************************************************************************/
// CDlgOptionsViewPage::OnInitDialog Dialog initialization
// The gridline comboboxes are subclassed with a userdrawn control.
/***************************************************************************/
...
void CDlgOptionsViewPage::OnAnimationRateScroll()
{
	...
	if (nIndex >= nOptionsCount) nIndex = nOptionsCount - 1;
...
/***************************************************************************/
// CDlgOptionsViewPage::EnableDynamicUpdate  enable dynamic graph update mode
/***************************************************************************/
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsColorPage message map

BEGIN_MESSAGE_MAP(CDlgOptionsColorPage, CPropertyPage)
	//{{AFX_MSG_MAP(CDlgOptionsColorPage)
...
void CComboColor::MeasureItem(LPMEASUREITEMSTRUCT lpMIS)
{
	...
	//CSize size = lpMIS->GetTextExtent((LPSTR)lpMIS->itemData, _tcslen((LPSTR)lpMIS->itemData);
	lpMIS->itemHeight = 15;
}
...
void CComboColor::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
	...
	if (lpDIS->itemState & ODS_FOCUS) pDC->DrawFocusRect(&lpDIS->rcItem);
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsColorPage construction/destruction/creation
...
{
	//{{AFX_DATA_INIT(CDlgOptionsColorPage)
	m_nGraphSelect = 0;
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsColorPage helper functions
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsColorPage message handlers
...
void CDlgOptionsColorPage::FillColorComboBoxInfo(BOOL bAddStrings)
{
	...
	for (i = 0; AnnotColorsComboInfo[i].pszColorItem; i++)
	{
		...
		else       AnnotColorsComboInfo[i].cColor = *(&m_cColors.cAnnotationBkg[PHONETIC] + i / 2);
...
{
	UpdateData(TRUE);
	if (m_nGraphSelect >= 0) ChangeColor(&m_cColors.cPlotBkg  + m_nGraphSelect);
...
{
	UpdateData(TRUE);
	if (m_nScaleSelect >= 0) ChangeColor(&m_cColors.cScaleBkg + m_nScaleSelect);
...
{
	UpdateData(TRUE);
	if (m_nOverlaySelect >= 0) ChangeColor(&(m_cColors.cPlotData[m_nOverlaySelect]));
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsFontPage message map

BEGIN_MESSAGE_MAP(CDlgOptionsFontPage, CPropertyPage)
	//{{AFX_MSG_MAP(CDlgOptionsFontPage)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsFontPage construction/destruction/creation
...
{
	//{{AFX_DATA_INIT(CDlgOptionsFontPage)
	m_szAnnotFontInfo = "";
	m_nAnnotListIndex = -1;
	m_szSampleText = "";
	//}}AFX_DATA_INIT
...
{
	if (m_pSampleFont) delete m_pSampleFont;
}
...
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgOptionsFontPage)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsSavePage message map

BEGIN_MESSAGE_MAP(CDlgOptionsSavePage, CPropertyPage)
	//{{AFX_MSG_MAP(CDlgOptionsSavePage)
...
/***************************************************************************/
// CDlgOptionsSavePage::CDlgOptionsSavePage Constructor
/***************************************************************************/
CDlgOptionsSavePage::CDlgOptionsSavePage() : CPropertyPage(CDlgOptionsSavePage::IDD)
{
	//{{AFX_DATA_INIT(CDlgOptionsSavePage)
...
/***************************************************************************/
// CDlgOptionsSavePage::DoDataExchange Data exchange
/***************************************************************************/
void CDlgOptionsSavePage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgOptionsSavePage)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgOptionsSavePage message handlers
...
void CDlgOptionsSavePage::ShowCurrentDefaultViews(BOOL bPermanent)
{
	...
	switch(nLayout)
	{
	case ID_LAYOUT_1:  nIconID = IDI_LAYOUT1;  break;
	case ID_LAYOUT_2A: nIconID = IDI_LAYOUT2A; break;
	case ID_LAYOUT_2B: nIconID = IDI_LAYOUT2B; break;
	case ID_LAYOUT_2C: nIconID = IDI_LAYOUT2C; break;
	case ID_LAYOUT_3A: nIconID = IDI_LAYOUT3A; break;
	case ID_LAYOUT_3B: nIconID = IDI_LAYOUT3B; break;
	case ID_LAYOUT_3C: nIconID = IDI_LAYOUT3C; break;
	case ID_LAYOUT_4A: nIconID = IDI_LAYOUT4A; break;
	case ID_LAYOUT_4B: nIconID = IDI_LAYOUT4B; break;
	case ID_LAYOUT_4C: nIconID = IDI_LAYOUT4C; break;
	case ID_LAYOUT_5:  nIconID = IDI_LAYOUT5;  break;
	case ID_LAYOUT_6A: nIconID = IDI_LAYOUT6A; break;
	case ID_LAYOUT_6B: nIconID = IDI_LAYOUT6B; break;
	default:           nIconID = 0;
	}

	if (nIconID) pIcon->SetIcon(((CSaApp *)AfxGetApp())->LoadIcon(nIconID));
	UpdateData(FALSE);
}
...
/////////////////////////////////////////////////////////////////////////////
// CDlgToolsOptions message map

BEGIN_MESSAGE_MAP(CDlgToolsOptions, CPropertySheet)
	//{{AFX_MSG_MAP(CDlgToolsOptions)
	ON_WM_CREATE()
...
/////////////////////////////////////////////////////////////////////////////
// CDlgToolsOptions construction/destruction/creation
...
{
	//{{AFX_DATA_INIT(CDlgToolsOptions)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgToolsOptions helper functions
...
void CDlgToolsOptions::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CDlgToolsOptions)
	// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

/////////////////////////////////////////////////////////////////////////////
// CDlgToolsOptions message handlers
