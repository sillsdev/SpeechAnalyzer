...
public:
  ...
  // Operations
private:
  HBRUSH GetBkgBrush() {return (HBRUSH)m_brBkg.GetSafeHandle();} // return background brush
protected:
  virtual void DoDataExchange(CDataExchange* pDX); // DDX/DDV support
  virtual void OnInitialUpdate();
public:
  CDataProcess* CreateWbProcess(int nFilterNumber); // creates a workbench process
