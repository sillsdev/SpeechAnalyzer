...
#include "sa_plot.h"
//#include "zgraph\Toolkit.h"
//#include "zgraph\scatter.h"
...
protected:
  ...
  virtual POINT MapVowelsToChart(CDC* /*pDC*/, FORMANT_FREQ & /*VowelFormant*/, int /*VowelSymbolHeight*/, zScatterGraph * /*pFormantChart*/,
    zGraphStruct& /*FormantChartParms*/, BOOL /*bFlip*/ = FALSE) {POINT p = {0,0}; return p;}
  void AnimateFrame(DWORD dwFrameIndex);
  void EndAnimation();

  // Generated message map functions
protected:
  //{{AFX_MSG(CFormantChart)
  //}}AFX_MSG
  DECLARE_MESSAGE_MAP()
};
