...
protected:
    ...
    afx_msg void OnPlaybackLeftToStart();
    afx_msg void OnPlaybackStartToRight();
    afx_msg void OnPlaybackLeftToStop();
    afx_msg void OnPlaybackStopToRight();
    afx_msg void OnPlayerPause();
    afx_msg void OnUpdatePlayerPause(CCmdUI * pCmdUI);
    afx_msg void OnPlayerResume();
    afx_msg void OnUpdatePlayerResume(CCmdUI * pCmdUI);
    afx_msg void OnPlayerToggle();
    afx_msg void OnUpdatePlayerToggle(CCmdUI * pCmdUI);
