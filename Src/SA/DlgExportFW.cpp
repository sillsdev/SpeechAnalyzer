...
void CDlgExportFW::OnAllAnnotations() {
    ...
    if (checked) {
        ...
        settings.bReference = FALSE;
        settings.bPhonetic = FALSE;
        settings.bPhonemic = FALSE;
        settings.bOrtho = FALSE;
        settings.bTone = FALSE;
        settings.bGloss = FALSE;
        settings.bGlossNat = FALSE;
